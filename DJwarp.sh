...
wget -N -6 https://cdn.jsdelivr.net/gh/kkkyg/DJwarp/wgcf -O /usr/local/bin/wgcf
wget -N -6 https://cdn.jsdelivr.net/gh/kkkyg/DJwarp/wireguard-go -O /usr/bin/wireguard-go
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/kkkyg/DJwarp/main/wgmd.sh && chmod +x wgmd.sh && ./wgmd.sh
}

function up6(){
echo -e nameserver 2a0b:f4c0:4d:53::1 > /etc/resolv.conf
wget -6 -N --no-check-certificate https://raw.githubusercontent.com/kkkyg/DJwarp/main/wgmd.sh && chmod +x wgmd.sh && ./wgmd.sh
}

#主菜单
function start_menu(){
    clear
    yellow " 详细说明 https://github.com/kkkyg/DJwarp  YouTube频道：甬哥侃侃侃" 
    
    red " 切记：进入脚本快捷方式 bash DJwarp.sh "
